...
# الشعار بالإنجليزية
st.markdown("<p style='text-align:center;color:gold;font-size:22px;'>TALK , PAY , DONE .</p>", unsafe_allow_html=True)

# الشعار بالعربية
st.markdown("<p style='text-align:center;color:gold;font-size:22px;'>تكلم ، ادفع ، تم .</p>", unsafe_allow_html=True)
